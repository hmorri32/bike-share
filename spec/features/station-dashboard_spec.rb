describe '/stations/dashboard' do
  before :each do
    ...
    Station.create(id:2, name: "San Jose Diridon Station", dock_count: 27, city: City.create(id:1, name: "San Jose"), installation_date: "2013-08-06", lat:0, lng:0)

    Station.create(id: 3, name: "Embarcadero", dock_count: 27, city: City.create(id:2, name: "San Francisco"), installation_date: "2013-08-05", lat:0, lng:0)
